...
function ResponsiveAppBar() {
  ...
  useEffect(() => {
    if (selectedPage === "Records") {
      navigate("/records");
    } else if (selectedPage === "Add Student") {
      navigate("/add-student");
    } else if (selectedPage === "Payment History") {
            ...
            >
              {pages.map((page) => (
                <MenuItem
                  key={page}
                  component={Link}
                  to={"/" + toUrlFormat(page)} // Replace spaces with dashes
                  onClick={() => handleNavbarPages(page)}
                >
